...
<section className="home-introduction" style={{ textAlign: 'center', marginBottom: '20px' }}>
  <h1 className="intro-title" style={{ fontSize: `${20 * textScale}px`, margin: '10px 0' }}>Welcome to CodeSparks - Where Fun Meets Function in Coding!</h1>
  ...
  <div className="intro-call-to-action" style={{ margin: '20px 0' }}>
...
<section className="home-features">
  ...
  <div className="features-grid flex-container">
    ...
    <div className="feature-item">
      ...
      <h3 className="feature-title" style={{ fontSize: `${20 * textScale}px`}}>Drag & Drop Coding Blocks</h3>
    ...
    <div className="feature-item">
      ...
      <h3 className="feature-title" style={{ fontSize: `${20 * textScale}px`}}>Interactive Tutorials</h3>
    ...
    <div className="feature-item">
      ...
      <h3 className="feature-title" style={{ fontSize: `${20 * textScale}px`}}>Real-World Projects</h3>
      ...
      <section className="home-educational-benefits">
        ...
        <ul className="benefits-list">
          <li className="benefit-item" style={{ fontSize: `${20 * textScale}px`}}>Critical Thinking - Solve problems and design projects with a logical approach.</li>
          <li className="benefit-item" style={{ fontSize: `${20 * textScale}px`}}>Creativity - Let your imagination soar with unlimited project possibilities.</li>
          <li className="benefit-item" style={{ fontSize: `${20 * textScale}px`}}>Collaboration - Team up with friends and tackle coding challenges together.</li>
          <li className="benefit-item" style={{ fontSize: `${20 * textScale}px`}}>Communication - Share your projects and ideas with the CodeSparks community.</li>
        </ul>
      </section>
